...
export const QueLeDoyError = () => {
  return (
    <div className='row'>
      <img className='col s6 error-image' src='https://c.tenor.com/SBAYO8dpFa8AAAAC/fidel-queledoy.gif'
           alt='que le doy?'/>
      <div className='col s6'> Parece que tu <b>teléfono</b> no figura en la lista de <b>invitados</b>, porfa comunicate
        conmigo
