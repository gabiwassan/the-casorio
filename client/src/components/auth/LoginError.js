  ...
  return (
    <div className="container">
      <div className="col s12">
        {' '}
        Tú <b>teléfono</b> no figura en la lista de <b>invitados</b>, podes comunicate conmigo{' '}
        <a href="https://wa.me/+543517654165">
          <b>acá</b>
        </a>
      </div>
      <div className="col s12">
        <img className="ardilla" src={noPhone} alt="noPhone?" />
      </div>
    </div>
  );
};
